...
const SignUp: React.FC = () => {
  ...
  const [onSubmit, { isLoading, isSuccess }] = useSignupMutation(); 
    ...
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-cente">
          <div className="hidden w-full xl:block xl:w-1/2 bg-theme-light dark:bg-theme-dark">
            <div className=" text-center"> {/* py-17.5 px-26 */}
              ...
              Join the team! And start tracking your training progress
              </p>

              <span className="mt-7 inline-block te">
                <svg
                  width="350"
                  height="350"
                  viewBox="0 0 350 350"
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full px-12 pt-10">{/* p-4 sm:p-12.5 xl:p-17.5 */}
              <h2 className="mb-9 text-2xl font-bold text-theme-light dark:text-white sm:text-title-xl2">
                Sign Up Tracker
              </h2>

              <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 mb-4 sm:grid-cols-2">
                {/*  first name */}
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-theme-light outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <select
                      className="w-full rounded-lg border border-stroke bg-transparent py-[17.5px] pl-6 pr-10 text-theme-light outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                      defaultValue=""
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <select
                      className="w-full rounded-lg border border-stroke bg-transparent py-[16.5px] pl-6 pr-10 text-theme-light outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                      {...register('gender', {
                        required: {
                          value: true,
                ...
                <button className="col-span-2 flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                  <span>
                    <svg
                      width="20"
                      height="20"
                ...
                <div className="mt-6 text-center col-span-2">
                  <p>
                    ...
                    <Link to="/auth/signin" className="text-theme-light">
                      Sign in
                    </Link>
                  </p>
                </div>
